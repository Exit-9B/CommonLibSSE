...
namespace RE
{
	...
	//			REL::Relocation<const Setting*> fSafeZoneXWide{ Offset::Setting::fSafeZoneXWide };
	//			REL::Relocation<const Setting*> fSafeZoneYWide{ Offset::Setting::fSafeZoneYWide };

	//			return std::make_pair(fSafeZoneXWide->GetFloat(), fSafeZoneYWide->GetFloat());
	//		} else {
	//			REL::Relocation<const Setting*> fSafeZoneX{ Offset::Setting::fSafeZoneX };
	//			REL::Relocation<const Setting*> fSafeZoneY{ Offset::Setting::fSafeZoneY };
