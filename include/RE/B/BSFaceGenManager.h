...
namespace RE
{
	...
	public:
		...
		{
			REL::Relocation<BSFaceGenManager**> singleton{ Offset::BSFaceGenManager::GetSingleton };
			return *singleton;
		}
		...
		void PrepareHeadPartForShaders(BSFaceGenNiNode* a_node, BGSHeadPart* a_headPart, TESNPC* a_npc)
		{
			...
			REL::Relocation<func_t> func{ Offset::BSFaceGenManager::PrepareHeadPartForShaders };
