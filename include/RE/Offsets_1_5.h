...
namespace RE
{
	namespace Offset
	{
		...
		{
			inline constexpr REL::ID GetArmorRatingSkillMultiplier(static_cast<std::uint64_t>(25858));
		...
		{
			inline constexpr REL::ID GetSingleton(static_cast<std::uint64_t>(514738));
		}

		namespace BSPointerHandleManager
		{
			inline constexpr REL::ID GetHandleEntries(static_cast<std::uint64_t>(514478));
		}
		...
		namespace Calendar
		{
			...
			inline constexpr REL::ID GetTimeDateString(static_cast<std::uint64_t>(35413));
		}
		...
		{
			inline constexpr REL::ID GetContainerMode(static_cast<std::uint64_t>(519396));
			inline constexpr REL::ID GetTargetRefHandle(static_cast<std::uint64_t>(519421));
		}
		...
		namespace Inventory3DManager
		{
			...
			inline constexpr REL::ID Clear3D(static_cast<std::uint64_t>(50886));
			inline constexpr REL::ID Render(static_cast<std::uint64_t>(50882));
		}

		namespace InventoryChanges
		{
			inline constexpr REL::ID GetArmorInSlot(static_cast<std::uint64_t>(15873));
		...
		namespace NiObject
		{
			inline constexpr REL::ID ProcessClone(static_cast<std::uint64_t>(68838));
