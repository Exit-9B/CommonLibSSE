...
namespace SKSE
{
	...
	public:
		...
		std::uint32_t noStructUse: 1 = 0;
		std::uint32_t addressLibraryV5: 1 = 1;
		std::uint32_t padding1: 30 = 0;
#endif
		std::uint32_t addressLibrary: 1 = 0;
		std::uint32_t sigScanning: 1 = 0;
		std::uint32_t structsPost629: 1 = 1;
		std::uint32_t padding2: 29 = 0;
